...
class CandiesScreen extends StatefulWidget {
  final User user;

  const CandiesScreen({Key key, this.user}) : super(key: key);

  @override
  _CandiesScreenState createState() => _CandiesScreenState();
}

class _CandiesScreenState extends State<CandiesScreen> {
  double screenWidth;
  double screenHeight;
  var _screenRatio = 2;
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                        height: 40,
                        width: 40,
                        child: Image.asset("assets/images/lollipop.png"))
                  ],
                ),
                SizedBox(
                  height: 10,
                                          ...
                                          children: [
                                            Container(
                                                ...
                                                child: CachedNetworkImage(
                                                    fit: BoxFit.cover,
                                                    imageUrl:
                                                        "https://hubbuddies.com/270607/snackeverywhere/images/product/${_candyList[index]['product_id']}.png")),
                                            Padding(
                                              padding:
  ...
  void _viewProduct(int index) {
    Product product = new Product(
      product_id: _candyList[index]["product_id"],
      product_name: _candyList[index]["product_name"],
      product_desc: _candyList[index]["product_desc"],
      product_small_price: _candyList[index]["product_small_price"],
      product_small_qty: _candyList[index]["product_small_qty"],
      product_large_price: _candyList[index]["product_large_price"],
      product_large_qty: _candyList[index]["product_large_qty"],
      product_cat: _candyList[index]["product_cat"],
      instock_qtysmall: _candyList[index]["instock_qtysmall"],
      instock_qtylarge: _candyList[index]["instock_qtylarge"],
      datePublished: _candyList[index]["datePublished"],
    );
