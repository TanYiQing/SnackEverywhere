...
class NutsScreen extends StatefulWidget {
  ...
  const NutsScreen({Key key, this.user}) : super(key: key);
  @override
...
class _NutsScreenState extends State<NutsScreen> {
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                        height: 40,
                        width: 40,
                        child: Image.asset("assets/images/peanuts.png"))
                  ],
                ),
                SizedBox(
                  height: 10,
                    ...
                    : Flexible(
                        child: Center(
                            child: GridView.count(
                                ...
                                children:
                                    List.generate(_nutList.length, (index) {
                                  return Padding(
                                          ...
                                          children: [
                                            Container(
                                                ...
                                                child: CachedNetworkImage(
                                                    fit: BoxFit.cover,
                                                    imageUrl:
                                                        "https://hubbuddies.com/270607/snackeverywhere/images/product/${_nutList[index]['product_id']}.png")),
                                            Padding(
                                              padding:
  ...
  void _loadproducts() {
    http.post(
        ...
        body: {"product_cat": "Nut"}).then((response) {
      print(response.body);
  ...
  void _viewProduct(int index) {
    Product product = new Product(
      product_id: _nutList[index]["product_id"],
      product_name: _nutList[index]["product_name"],
      product_desc: _nutList[index]["product_desc"],
      product_small_price: _nutList[index]["product_small_price"],
      product_small_qty: _nutList[index]["product_small_qty"],
      product_large_price: _nutList[index]["product_large_price"],
      product_large_qty: _nutList[index]["product_large_qty"],
      product_cat: _nutList[index]["product_cat"],
      instock_qtysmall: _nutList[index]["instock_qtysmall"],
      instock_qtylarge: _nutList[index]["instock_qtylarge"],
      datePublished: _nutList[index]["datePublished"],
    );
