...
class SnackScreen extends StatefulWidget {
  ...
  const SnackScreen({Key key, this.user}) : super(key: key);
...
class _SnackScreenState extends State<SnackScreen> {
                    ...
                    : Flexible(
                        child: Center(
                            child: GridView.count(
                                ...
                                children:
                                    List.generate(_snackList.length, (index) {
                                  return Padding(
                                          ...
                                          children: [
                                            Container(
                                                ...
                                                child: CachedNetworkImage(
                                                    fit: BoxFit.cover,
                                                    imageUrl:
                                                        "https://hubbuddies.com/270607/snackeverywhere/images/product/${_snackList[index]['product_id']}.png")),
                                            Padding(
                                              padding:
  ...
  void _loadproducts() {
    http.post(
        ...
        body: {"product_cat": "Snack"}).then((response) {
      print(response.body);
  ...
  void _viewProduct(int index) {
    Product product = new Product(
      product_id: _snackList[index]["product_id"],
      product_name: _snackList[index]["product_name"],
      product_desc: _snackList[index]["product_desc"],
      product_small_price: _snackList[index]["product_small_price"],
      product_small_qty: _snackList[index]["product_small_qty"],
      product_large_price: _snackList[index]["product_large_price"],
      product_large_qty: _snackList[index]["product_large_qty"],
      product_cat: _snackList[index]["product_cat"],
      instock_qtysmall: _snackList[index]["instock_qtysmall"],
      instock_qtylarge: _snackList[index]["instock_qtylarge"],
      datePublished: _snackList[index]["datePublished"],
    );
