...
class DrinksScreen extends StatefulWidget {
  ...
  const DrinksScreen({Key key, this.user}) : super(key: key);
...
class _DrinksScreenState extends State<DrinksScreen> {
                    ...
                    : Flexible(
                        child: Center(
                            child: GridView.count(
                                ...
                                children:
                                    List.generate(_drinkList.length, (index) {
                                  return Padding(
                                          ...
                                          children: [
                                            Container(
                                                ...
                                                child: CachedNetworkImage(
                                                    fit: BoxFit.cover,
                                                    imageUrl:
                                                        "https://hubbuddies.com/270607/snackeverywhere/images/product/${_drinkList[index]['product_id']}.png")),
                                            Padding(
                                              padding:
  ...
  void _loadproducts() {
    http.post(
        ...
        body: {"product_cat": "Drink"}).then((response) {
      print(response.body);
  ...
  void _viewProduct(int index) {
    Product product = new Product(
      product_id: _drinkList[index]["product_id"],
      product_name: _drinkList[index]["product_name"],
      product_desc: _drinkList[index]["product_desc"],
      product_small_price: _drinkList[index]["product_small_price"],
      product_small_qty: _drinkList[index]["product_small_qty"],
      product_large_price: _drinkList[index]["product_large_price"],
      product_large_qty: _drinkList[index]["product_large_qty"],
      product_cat: _drinkList[index]["product_cat"],
      instock_qtysmall: _drinkList[index]["instock_qtysmall"],
      instock_qtylarge: _drinkList[index]["instock_qtylarge"],
      datePublished: _drinkList[index]["datePublished"],
    );
