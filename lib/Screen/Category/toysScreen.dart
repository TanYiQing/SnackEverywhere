...
class ToysScreen extends StatefulWidget {
  ...
  const ToysScreen({Key key, this.user}) : super(key: key);
...
class _ToysScreenState extends State<ToysScreen> {
                    ...
                    : Flexible(
                        child: Center(
                            child: GridView.count(
                                ...
                                children:
                                    List.generate(_toyList.length, (index) {
                                  return Padding(
                                          ...
                                          children: [
                                            Container(
                                                ...
                                                child: CachedNetworkImage(
                                                    fit: BoxFit.cover,
                                                    imageUrl:
                                                        "https://hubbuddies.com/270607/snackeverywhere/images/product/${_toyList[index]['product_id']}.png")),
                                            Padding(
                                              padding:
  ...
  void _loadproducts() {
    http.post(
        ...
        body: {"product_cat": "Toy"}).then((response) {
      print(response.body);
  ...
  void _viewProduct(int index) {
    Product product = new Product(
      product_id: _toyList[index]["product_id"],
      product_name: _toyList[index]["product_name"],
      product_desc: _toyList[index]["product_desc"],
      product_small_price: _toyList[index]["product_small_price"],
      product_small_qty: _toyList[index]["product_small_qty"],
      product_large_price: _toyList[index]["product_large_price"],
      product_large_qty: _toyList[index]["product_large_qty"],
      product_cat: _toyList[index]["product_cat"],
      instock_qtysmall: _toyList[index]["instock_qtysmall"],
      instock_qtylarge: _toyList[index]["instock_qtylarge"],
      datePublished: _toyList[index]["datePublished"],
    );
